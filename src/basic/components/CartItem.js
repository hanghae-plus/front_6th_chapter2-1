...
export default function CartItem(product) {
  return /* HTML */ `
    ...
    >
      ...
      <div>
        <h3 class="text-base font-normal mb-1 tracking-tight">${createProductName(product)}</h3>
        <p class="text-xs text-gray-500 mb-0.5 tracking-wide">PRODUCT</p>
        <p class="text-xs text-black mb-3">${ProductPrice(product, 'xs')}</p>
