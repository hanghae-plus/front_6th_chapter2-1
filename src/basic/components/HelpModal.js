...
export function HelpModal() {
  ...
  manualToggle.innerHTML = renderHelpButton();
  ...
  manualColumn.innerHTML = renderHelpModal();
 ...
 * 도움말 버튼 렌더링 함수
 *
 * @description 도움말 버튼 HTML 문자열을 생성
 *
 * @returns {string} 도움말 버튼 HTML 문자열
 */
export const renderHelpButton = () => {
  return `
 ...
 * 도움말 모달 렌더링 함수
 *
 * @description 도움말 모달 HTML 문자열을 생성
 *
 * @returns {string} 도움말 모달 HTML 문자열
 */
