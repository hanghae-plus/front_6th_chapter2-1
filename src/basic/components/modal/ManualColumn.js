...
export function createManualColumn() {
  ...
  manualColumn.innerHTML = `
    <button class="absolute top-4 right-4 text-gray-500 hover:text-black" onclick="document.querySelector('.manual-overlay').classList.add('hidden'); this.parentElement.classList.add('translate-x-full')">
